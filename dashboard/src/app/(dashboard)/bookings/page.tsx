      ...
      <Header
        ...
        actions={
          <div className="flex gap-1.5">
            ...
            <Button size="sm" onClick={() => setShowModal(true)} className="px-2 sm:px-3" title="New Booking"><Plus size={14} /><span className="hidden sm:inline"> New Booking</span></Button>
          </div>
        }
      />
